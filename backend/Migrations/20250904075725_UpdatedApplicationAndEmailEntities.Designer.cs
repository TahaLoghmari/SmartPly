...
namespace backend.Migrations
{
    ...
    [Migration("20250904075725_UpdatedApplicationAndEmailEntities")]
    partial class UpdatedApplicationAndEmailEntities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("backend.Entities.Email", b =>
                {
                    ...
                    b.Property<int>("AiProcessingRetryCount")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("backend.Entities.HangfireJob", b =>
                {
            ...
            modelBuilder.Entity("backend.Entities.User", b =>
                {
                    ...
                    b.Property<bool>("IsInitialSyncStarted")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false);

                    b.Property<bool>("IsRecurringCleanupScheduled")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false);

                    b.Property<bool>("IsRecurringSyncScheduled")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false);
            ...
            modelBuilder.Entity("backend.Entities.Email", b =>
                {
                    b.HasOne("backend.Entities.Application", "Application")
                        .WithMany("Emails")
                        .HasForeignKey("MatchedJobId")
                        .OnDelete(DeleteBehavior.SetNull);
