...
export function LoginPage() {
  ...
  return (
    ...
    <div className="bg-background flex w-screen flex-col items-center sm:my-20 sm:w-[450px] sm:rounded-md">
      <div className="flex min-h-screen w-[90%] flex-col items-center gap-8 py-10 sm:min-h-0">
        <svg
