import { useDeleteApplicationResume } from "#/applications";
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
...
export default function ApplicationRemoveResumeButton({
  applicationId,
  resumeId,
}: {
  ...
  const { isPending, DeleteApplicationResume } = useDeleteApplicationResume(
    applicationId,
    () => setOpen(false),
  );
    ...
    <AlertDialog open={open} onOpenChange={setOpen}>
      ...
      <AlertDialogContent>
        ...
        <AlertDialogFooter>
          ...
          <AlertDialogAction onClick={() => DeleteApplicationResume(resumeId)}>
            {isPending ? (
