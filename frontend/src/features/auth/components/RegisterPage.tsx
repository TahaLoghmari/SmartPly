        ...
        >
          {getGoogleOAuthUrlMutation.isPending ? (
            ...
            <>
              ...
              <p className="text-primary">Sign up with Google</p>
            </>
          )}
        </Button>
        <div className="relative flex w-full items-center">
          <div className="flex-grow border-t-1 border-gray-400"></div>
