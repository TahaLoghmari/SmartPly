...
export function ForgotPasswordPage() {
  ...
  return (
    <div className="from-background via-background to-muted flex min-h-screen w-screen flex-col items-center bg-gradient-to-br sm:rounded-md">
      <div className="bg-card text-card-foreground border-border/50 flex w-full flex-col items-center gap-6 border p-9 shadow-2xl sm:my-20 sm:w-[450px] sm:rounded-lg sm:p-12">
