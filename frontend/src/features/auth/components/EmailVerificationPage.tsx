...
export function EmailVerificationPage() {
  ...
  return (
    <div className="from-background via-background to-muted flex min-h-screen w-screen flex-col items-center bg-gradient-to-br sm:rounded-md">
      <div className="bg-card text-card-foreground border-border/50 flex w-full flex-col items-center gap-8 border p-9 shadow-2xl sm:my-20 sm:w-[480px] sm:rounded-lg sm:p-12">
        <svg
        ...
        <div className="flex w-full items-center justify-center rounded-lg border border-yellow-200 bg-yellow-50 p-4 dark:border-yellow-800 dark:bg-yellow-900/20">
          <p className="text-sm text-yellow-800 dark:text-yellow-200">
            <strong>Note:</strong> You might need to check your spam folder.
          </p>
        </div>
